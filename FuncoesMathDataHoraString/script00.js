...
console.log(Math.max(1,3,6,9,2,5)); //9 (pega o maior numero)
console.log(Math.min(1,3,6,9,2,5)); //1 (pega o menor numero)
console.log(Math.abs(-10)); //10 (faz o numero ficar positivo)
